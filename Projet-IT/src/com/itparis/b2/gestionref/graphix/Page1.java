...
//import com.itparis.b2.gestionref.basics.User;
...
public class Page1 extends JFrame implements ActionListener{
	...
	public Page1() {
		...
		lblCesInformationsVous.setBounds(49, 35, 553, 33);
		...
		lblCivilit.setFont(new Font("Tahoma", Font.BOLD, 11));
		pan.add(lblCivilit);
		...
		lblLieuDeRsidence.setBounds(49, 282, 145, 16);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String ville = txtVille_1.getText();
				String siteweb = txtSiteWeb.getText();
				if(ville.equals("")){
//					JOptionPane.showMessageBox("renseignez la ville");
				}
